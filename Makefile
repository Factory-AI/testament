...
lint: _python-check
	...
	@$(PYTHON) -m json.tool docs/research/analysis/injection-control-evidence.json >/dev/null
	@$(PYTHON) -m json.tool docs/research/analysis/evaluation-candidate-evidence.json >/dev/null
...
verify-analyzer-evaluation:
	...
	@$(MAKE) verify-analyzer-candidate

verify-analyzer-candidate:
	@$(PYTHON) scripts/verify_analyzer_candidate.py --root .
